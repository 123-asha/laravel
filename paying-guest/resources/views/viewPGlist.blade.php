			...
			<!--<section class="pricing py-5" id="pricings">-->
				...
				<div class="container py-xl-5 py-lg-3">
					...
					<div class="text-center mb-lg-5 mb-4">
						<h3 class="tittle mb-2 text-white">Our Ads</h3>
						<p class="test-title-paara">Find your pg</p>
					</div>
						...
						<div class="card-deck text-center row mt-5">
							...
							<div class="price-inner">
								<div class="price-header" style="padding: 20px" >
										...
										<img src="{{asset('storage/pgimages/'.$post->images)}}" class="img-fluid" alt="img" style="height:150px; width: 150px; padding-top:">
									</div>
									<div class="price-body"style="padding-top: 10px" >
										<h6 class="pricing-title">
										 {{$post->title}}
										</h6>
									<a href="/view-details/{{$post->id}}" class="btn btn-block py-2" >
											<i class="far fa-user"></i> view Details</a>
										</div>
								</div>
						    </div>
