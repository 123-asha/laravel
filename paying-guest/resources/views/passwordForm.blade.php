					...
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item mx-xl-4 mx-lg-3 my-lg-0 my-3">
									<a class="nav-link active" href="/addPG">Add </a>
								</li>
								<li class="nav-item">
...
@csrf
      <label for="password" class=" text-white">Change Your Password</label><br>
      <input type="password"  class="" id="password" required  name="password" ><br><br>
